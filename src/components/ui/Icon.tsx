/**
 * Single-stroke, monochrome icons that inherit `currentColor`, so they always
 * match the active theme without a per-theme asset (Apple/Notion style, no
 * emoji). An unknown name falls back to the three-dot glyph rather than
 * rendering nothing.
 */
...
export const ICON_PATHS: Record<string, string> = {
  ...
  workflow: 'M12 2v4m0 12v4M4.9 4.9l2.9 2.9m8.4 8.4 2.9 2.9M2 12h4m12 0h4M4.9 19.1l2.9-2.9m8.4-8.4 2.9-2.9',
  folder: 'M3 7a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7z',
  check: 'M9 11l3 3L22 4M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11',
  // The bare tick. `check` draws a ticked box, which is right for a nav item
  // but wrong inside a checkbox or beside an already-selected menu row.
  tick: 'M5 13l4 4L19 7',
  board: 'M3 3h7v18H3V3zm11 0h7v11h-7V3z',
  clock: 'M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20zm0-16v6l4 2',
  calendar: 'M8 2v4M16 2v4M3 10h18M5 4h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2z',
  gantt: 'M4 6h10M4 12h14M4 18h7M3 3v18',
  ...
  pin: 'M12 17v5M9 10.76V4h6v6.76l2.5 3.24H6.5L9 10.76z',
};
